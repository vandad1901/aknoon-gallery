    ...
    return (
        <main className="m-4 grid h-full grid-cols-1 justify-items-center gap-4 md:m-6 md:grid-cols-2">
            <p
                ...
                lang="fa">
                گالری <strong className="text-aknoon"> اکنون </strong> از سال
                ۱۳۹۳ تلاش کرده‌است، بین آفرینشگران آثار هنری و علاقمندان به این
                آثار، پیوندی جدید برقرار کند. گالری
                ...
                <strong className="text-aknoon"> اکنون </strong> سری بزنید. و
                اگر به دنبال زنده کردن خاطره ای،‌ اجرای مراسمی، به جای آوردن
                وعدهای یا دادن هدیه ای باشید یا شاید بخواهید با ساخته دست یک
                هنرمند یا صنعتگر به فضای زندگی یا محیط کارتان زیبایی بیشتری
                ببخشید، به سراغمان بیایید. اطمینان داریم در اینجا، در گالری
