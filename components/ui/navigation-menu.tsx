...
>(({ className, ...props }, ref) => (
    <NavigationMenuPrimitive.Viewport
        className={cn(
            "origin-top-center absolute flex justify-center overflow-hidden text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90",
            className,
        )}
        ref={ref}
        {...props}
