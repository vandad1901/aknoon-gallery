    ...
    return (
        <Sheet open={open} onOpenChange={setOpen}>
            <SheetTrigger asChild>
                <Button
                    variant="ghost"
                    className="h-8 w-8 rounded-md border-2 p-1 text-base focus-visible:bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 sm:hidden">
                    <Menu aria-hidden={true} className="h-full w-full stroke-gray-600" />
            ...
            <SheetContent side="right" className="pl-2 pr-3 pt-14">
                ...
                <ScrollArea dir="rtl" className="h-full w-full pb-5 pl-4">
                    <div className="flex flex-col space-y-3 pt-4">
                        <MobileLink href="artworks" onOpenChange={setOpen} className="font-medium">
                            آثار
                        </MobileLink>
                        <MobileLink href="about" onOpenChange={setOpen} className="font-medium">
                            درباره ما
                        </MobileLink>
                        <MobileLink href="contact" onOpenChange={setOpen} className="font-medium">
                            تماس با ما
                        </MobileLink>
